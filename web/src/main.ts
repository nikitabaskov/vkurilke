...
function showSettings(): void {
  if (!me) return;
  const options: [keyof Preferences, string, string][] = [['session', 'Кто-то вышел', 'Карточка нового сеанса в боте'], ['arrival', 'Компания пополнилась', 'Кто-то пришел или спустился'], ['departure', 'Кто-то вернулся', 'Участник выключил свой статус']];
